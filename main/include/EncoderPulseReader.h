...
struct pcnt_config_t
{
    ...
    pcnt_channel_edge_action_t neg_edge_action = PCNT_CHANNEL_EDGE_ACTION_HOLD;       /**< Action on negative edge. */
...
public:
    ...
    /**
     * @brief Gets the current pulse count from the counter.
     * @param velocity Pointer to store the pulse count value.
     */
    void get_pulse_count(int *count);
